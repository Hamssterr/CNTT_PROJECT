...
const courses = [
  {
    ...
    description: "Master the basics of ReactJS and build modern web applications with this comprehensive course.",
    instructor: "John Doe",
    price: "49.99",
    image: image,
  },
  {
    ...
    description: "Dive deep into JavaScript with ES6+, async programming, and functional concepts.",
  ...
  {
    title: "HTML & CSS Pro",
    description: "Become a pro at building responsive and beautiful websites with HTML and CSS.",
  ...
  },
  {
    ...
    description: "Learn server-side development with Node.js and build scalable applications.",
  ...
  },
  {
    ...
    description: "Explore data analysis and visualization with Python, Pandas, and Matplotlib.",
