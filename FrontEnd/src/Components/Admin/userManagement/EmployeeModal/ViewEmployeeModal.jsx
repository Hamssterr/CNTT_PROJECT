...
const ViewUserModal = ({ show, onClose, user }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-40 flex justify-center items-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl relative z-50 max-h-[80vh] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white p-6 relative shrink-0">
        ...
        {/* Content */}
        <div className="overflow-y-auto flex-1 max-h-[calc(80vh-140px)]">
              ...
              <h4 className="text-lg font-semibold text-amber-800 mb-4 flex items-center">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2V6m8 0H8m8 0h2a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8a2 2 0 012-2h2"
                  />
                </svg>
