        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              required
              autoComplete="given-name" // Thêm autocomplete cho tên
            />
            <input
              type="text"
              ...
              className="border p-2 rounded-md w-full"
              required
              autoComplete="family-name" // Thêm autocomplete cho họ
            />
          </div>
          ...
          <input
            ...
            className="border p-2 rounded-md w-full"
            required={!isEditMode}
            autoComplete={isEditMode ? "current-password" : "new-password"} // Thêm autocomplete cho mật khẩu
          />
          ...
          <div className="border p-4 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-line1" // Thêm autocomplete cho số nhà
              />
              <input
                type="text"
                placeholder="Street"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-line2" // Thêm autocomplete cho tên đường
              />
              <input
                type="text"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-level4" // Thêm autocomplete cho phường/xã
              />
              <input
                type="text"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-level3" // Thêm autocomplete cho quận/huyện
              />
              <input
                type="text"
                placeholder="City"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-level2" // Thêm autocomplete cho thành phố
              />
              <input
                type="text"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="address-level1" // Thêm autocomplete cho tỉnh
              />
              <input
                type="text"
                placeholder="Country"
                ...
                className="border p-2 rounded-md w-full"
                autoComplete="country-name" // Thêm autocomplete cho quốc gia
              />
            </div>
          </div>
            ...
            {formData.degree.map((degree, index) => (
              ...
              >
                <input
                  ...
                  className="border p-2 rounded-md w-full"
                  required
                  autoComplete="off" // Tắt autocomplete cho trường không chuẩn
                />
                <input
                  type="text"
            ...
            {formData.experience.map((experience, index) => (
              ...
              >
                ...
                <input
                  ...
                  className="border p-2 rounded-md w-full"
                  required
                  autoComplete="organization" // Thêm autocomplete cho tên công ty
                />
                <input
                  type="date"
