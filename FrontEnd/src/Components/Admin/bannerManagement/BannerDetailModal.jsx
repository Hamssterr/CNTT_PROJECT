...
const BannerDetailModal = ({ isOpen, onClose, bannerDetail }) => {
  ...
  const getGradientCSS = (gradientClass) => {
    ...
    return (
      gradientMap[gradientClass] || "linear-gradient(135deg, #6b7280, #374151)"
    );
  };
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <InfoCard icon={FileText} title="Basic Information" color="blue">
                ...
                <InfoItem
                  label="📄 Description"
                  value={bannerDetail.description}
                />
                <InfoItem
                  label="🔘 Button Text"
                  value={bannerDetail.buttonText}
                />
              ...
              >
                ...
                />
                <InfoItem label="🔢 Number" value={bannerDetail.number} />
                <InfoItem
                  ...
                  <div className="absolute inset-0 p-4 md:p-6 lg:p-8 flex flex-col justify-center text-white">
                    <div className="max-w-lg">
                      ...
                      {bannerDetail.buttonText && (
                        <button
                          className={`inline-block rounded-full px-4 md:px-6 py-2 md:py-3 font-semibold text-sm md:text-base transition-all duration-300 hover:scale-105 hover:shadow-lg ${
                            bannerDetail.buttonColor || "text-blue-600"
                          } bg-white shadow-md`}
                        >
                          {bannerDetail.buttonText}
                        </button>
