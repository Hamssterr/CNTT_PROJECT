...
const Navbar = () => {
  ...
  useEffect(() => {
    const fetchParentData = async () => {
      try {
        const { data } = await axios.get(`${backendUrl}/api/parent/dashboard`, {
  ...
  return (
    <>
      ...
      {/* Enhanced Navbar */}
      <nav className="bg-gradient-to-r from-white via-orange-50/30 to-white backdrop-blur-sm py-4 px-6 flex items-center justify-between border-b border-gray-200 shadow-lg relative">
        {/* Subtle background pattern */}
        <div className="absolute inset-0 bg-gradient-to-r from-orange-50/40 via-transparent to-pink-50/40 pointer-events-none"></div>
        ...
        <div className="flex-shrink-0 flex items-center relative z-10">
          <div className="relative group">
            <img
              ...
              alt="Logo"
            />
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-orange-400/20 to-pink-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </div>
          <div className="hidden md:flex flex-col ml-4">
            ...
            <span className="text-sm text-gray-500 font-medium">
              Hello{" "}
              {isLoggedIn && parentData?.firstName
        ...
        <div className="flex-grow mx-6 min-w-0 max-w-md relative z-10">
          <div className="relative w-full group">
            <input
              ...
              className="w-full h-12 py-3 px-5 pl-12 bg-white/80 backdrop-blur-sm border-2 border-gray-200 rounded-2xl focus:outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100 transition-all duration-300 shadow-sm hover:shadow-md text-gray-700 placeholder-gray-400"
            />
            <Search
              ...
              size={20}
            />
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-400/10 to-pink-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4 flex-shrink-0 relative z-10">
          {isLoggedIn && parentData ? (
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      <div className="py-2">
                        ...
                        <button
                          className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-orange-50 transition-colors duration-200 text-left group"
                          onClick={() => {
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                className="group relative flex items-center space-x-2 px-6 py-2.5 border-2 border-orange-500 text-orange-600 rounded-2xl font-semibold text-sm transition-all duration-300 ease-in-out hover:bg-orange-500 hover:text-white hover:shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
              ...
              <button
                className="group relative flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-2xl font-semibold text-sm transition-all duration-300 ease-in-out hover:from-orange-600 hover:to-pink-600 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 md:inline-flex hidden"
          ...
          {isLoggedIn && (
            <button
              className="md:hidden p-3 rounded-2xl hover:bg-orange-100/80 transition-all duration-300 group"
              onClick={toggleMobileMenu}
            >
              <Menu
                size={24}
                className={`text-gray-600 group-hover:text-orange-600 transition-all duration-300 ${
